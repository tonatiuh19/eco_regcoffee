...
$sqlu = "SELECT a.id_payments, a.amount, a.note_fan, a.isPublic_note_fan, a.date, c.user_name, d.title, d.id_extra, a.id_openpay, a.email_user, a.description, a.question_answer, d.question, e.id_payments_complete, e.subsciption, a.customer_id, d.subsciption_id 
    ...
    WHERE (a.status='completed' or a.status='pending') and d.active=1 and d.subsciption=1 and b.id_user=".$userId."
                        ...
                        <div class="card-body text-primary">
                          ...
                          if($rowu["id_payments_complete"]==null){
                            ...
                            if($rowu['subsciption'] == '1'){
                              $output .= '<button type="button" class="btn btn-danger ms-1" data-bs-toggle="modal" data-bs-target="#cancel'.$rowu["id_payments"].'">Reiniciar</button>';
                            }else{
