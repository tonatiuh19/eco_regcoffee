							...
							<div class="card-text">
								<div class="container">
									<div class="row text-center">
										...
										<div class="col-6">
											<form class="boxed row fw-bold">
												<div class="col-4">
													<input type="radio" id="1" name="skills" value="Android Development" />
													<label htmlFor="1">1</label>
												</div>

												<div class="col-4">
													<input type="radio" id="2" name="skills" value="iOS Development" />
													<label htmlFor="2">3</label>
												</div>

												<div class="col-4">
													<input type="radio" id="3" name="skills" value="iOS Development" />
