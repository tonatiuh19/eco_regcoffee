            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-body">
                  ...
                  <div class="row text-center">
                    <div class="col-12 mb-2">
                    Revisa tu correo o entra a tu cuenta donde puedes administrar tu subcripcion, asi como tambien encontrar tu primer recibo de pago y un mensaje especial.
                    </div>
                  </div>
                  <div class="row text-center">
                    <div class="col-12">
