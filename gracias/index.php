            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-body">
                  ...
                  <div class="row text-center">
                    <div class="col-12 mb-2">
                    Tu suscripción se encuentra en proceso. Registra tu cuenta donde puedes administrar tu suscripción, asi como tambien encontrar tu primer recibo de pago, en tu correo un mensaje especial ;).
                    </div>
                  </div>
                  <div class="row text-center">
                    <div class="col-12">
